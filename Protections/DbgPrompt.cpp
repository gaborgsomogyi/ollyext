...
void dbgPromptApply( bool protect )
{
	if( protect )
	{
		...
		ASSEMBLE_AND_STEP( L"mov ecx imm:00000003", localEip );
		...
		ASSEMBLE_AND_STEP( L"int imm:2d", localEip );
		ASSEMBLE_AND_STEP( L"ret_near imm:000C", localEip );
