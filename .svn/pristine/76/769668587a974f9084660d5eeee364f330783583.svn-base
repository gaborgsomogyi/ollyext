...
t_menu g_dumpSubMenu[] =
{
	...
	{ L"Signature Rip to Clipboard", L"Rip selected signature to clipboard", K_NONE, menuDumpRipSignature, NULL, 0 },
...
int menuDumpRipSignature( t_table* pt, wchar_t* name, ulong index, int mode )
{
	if( mode == MENU_VERIFY )
	{
		return MENU_NORMAL;
